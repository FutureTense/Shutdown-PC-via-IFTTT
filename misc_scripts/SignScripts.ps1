...
if (!$CheckOnly) {
    "Signing scripts:`n"
    foreach ($s in $files){
        if ((Get-AuthenticodeSignature -FilePath $s).Status -ne "valid"){
            Set-AuthenticodeSignature $s $cert -TimestampServer http://timestamp.comodoca.com/authenticode
        }
    }
} else {
    "`n`nVerifing scripts:`n"
    foreach ($s in $files){
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUmH6xuHordjOHeu7HteWl37oK
# +6igghQlMIIEfTCCA2WgAwIBAgIDG+cVMA0GCSqGSIb3DQEBCwUAMGMxCzAJBgNV
...
# hkiG9w0BCQQxFgQUjyYU+sDXr8xpeXNBMYJScxj2NHUwDQYJKoZIhvcNAQEBBQAE
# ggIAEC9rLYpqI9CW8+0xeVrQk6uqytB7KGnRefnpV847l0mrHnrZb7L8OHVqrVsr
# RZ24YK4Qav+5Nn79kR8G2uYINWYMRHiQpeU0pv0TfEbuHuFz+we6Fm0RbrF3kMHZ
# r71CUd6TkO1zG7uL8iqkWgCSlifTKezp4j1vQb/QjH9s2seAUTUVDkm9KvPfkDO9
# 54L/PbsNyP5I1hKOaPAMJojiWucu99NWPXPsMcFLkz7viL436uz4YeVAgDM7Ewyp
# JRVQ9Vaes1KKgzxdtBWW9FZAdvhsaD0i5K3VlXbwQ6HuIJTUxWsU0OCk8K1GzO3e
# 4mI8GrwwFu6tNmnBw/TCREEWiu2iNXerIYq4/Uh0IJeGoqWYmLR7h4GMoqKD+gqh
# iRPSqOfsnbIEYkRlCvKhqh9nEGAdjqlwVicl01T64uHDTF6EJReG6Q8pgaAon8ny
# ubjEPOL2uvyd00G0pSz9MSqz/vakZgz3BAaElEUqZ+aAWuGD0VNnuw+5HraQAWlh
# 7Q9MNlQUsqtWmsSnOq0Z9VWF5e/seHh0Do7QpHdb975DJmWQdYsuaz+CWKH9/O0s
# 1O5q5VWHVigzYJQQRRuMw5nK38xtT0zoM5KcARxpsqFWHc1GeaNls7IoEYNZhrq/
# HULplS7T2Q36acDrIXMNtOD45Ffq/J0gOhexoCCyvjwyUiehggJDMIICPwYJKoZI
...
# BTEPFw0xOTAxMDMxNTA1MzlaMCMGCSqGSIb3DQEJBDEWBBRoha0uTcg+raEwy047
# TceX+zhI/jANBgkqhkiG9w0BAQEFAASCAQBK+OiDe3la6bJJPn6oB2zEXQpbohnW
# UBblLlqATO7EdfGeohCXOuVCyb65404mEzz7qHx6l4dYkb3JTqmfkxZJDU4IA4Xc
# PutM5KhjeEpDBFv4hLCMqnMg26rDoPDXAFppZMYNrSYxwRKmQHV6rx3JE6zHVYSp
# kqPxffD3dLlez57uIxX1h9WMIpuoFz6Ei5nMb7pVa8EfTrK4iWhpCmfD+5K0aM52
# EZ9Tg0M0t9Zn09HIckLl2obmZBF4MpBmTPoNlG3zPyhuggweqZyB7K3vY5NeH3o/
# BFWT3ST0grfWWcUqpdLPVIz2XY/QPu+oUf68PMwIU4lLY35apGHh3HG1
